...
Also improving a few things to make the game seem more natural. Altered the AI a fair bit trying to make slimes less likely to be idle. Slimes that are idle will now increase their defense so the player should try and kill the slimes before they get too strong.
